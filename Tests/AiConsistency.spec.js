...
test('Validate AI logging', async ({ request }) => {
    ...
    // Étape 1 : Soumettre une évaluation et vérifier que le feedback est bien enregistré
    ...
    // Étape 2 : Vérifier que la note a bien été enregistrée en récupérant les logs
    ...
    // Étape 3 : Vérifier que le feedback soumis est bien enregistré dans les logs
